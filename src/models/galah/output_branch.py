...
from src.utils.galah.config import NUM_ARMS, OUTPUT_DIM_PER_ARM

# ── 차원 상수 ──────────────────────────────────────────────────────────────────
CNN_OUT_DIM   = NUM_ARMS * OUTPUT_DIM_PER_ARM  # 4 * 1600 = 6400
DENSE_OUT_DIM = 128
FUSION_DIM    = CNN_OUT_DIM + DENSE_OUT_DIM   # 6528
