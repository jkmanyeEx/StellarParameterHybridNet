...
from src.models.galah.cnn_branch import build_cnn_branch
from src.models.galah.dense_branch import build_feature_branch
from src.models.galah.fusion import run_knowledge_fusion
from src.models.galah.output_branch import build_output_branch
...
class StellarParameterHybridNet(nn.Module):
    def __init__(self, use_features=True):
        ...
        if self.use_features:
            ...
            self.output_branch = build_output_branch(in_dim=6400 + 128)
        else:
            self.feature_branch = None
            self.output_branch = build_output_branch(in_dim=6400)
