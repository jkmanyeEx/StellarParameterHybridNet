...
class StellarHybridDataset(Dataset):
    """
    APOGEE 3-arm dataset with split-then-normalize and per-arm physical augmentation.
    """
    ...
    def __init__(self,
        ...
        self.num_arms      = raw_fluxes.shape[1]  # 3
        self.n_pixels      = raw_fluxes.shape[2]  # 2800
        ...
        print(f"   [APOGEE Dataset] {self.final_samples} samples | "
              f"augment={augment} | "
